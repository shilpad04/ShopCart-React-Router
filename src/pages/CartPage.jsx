        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    ...
                    <span className="ml-3 text-sm text-slate-300">
                      Item total: <span className="font-semibold text-slate-100">{(p.price * p.quantity).toFixed(2)}</span>
                    </span>
                  </div>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="rounded-xl border border-slate-800 p-5 bg-slate-900/60 lg:sticky lg:top-24 w-full">
              ...
              <p className="text-xs text-slate-400 mt-2">Taxes and shipping calculated at checkout.</p>
            </div>
          </div>
        </div>
      )}
