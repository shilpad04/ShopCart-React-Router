...
function ProductCard({ product, onAddCart, inCart }) {
  return (
    <div className="product">
      <div className="group flex flex-col rounded-2xl border border-slate-800 bg-slate-900/70 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition p-4 sm:p-5 min-h-[420px] text-slate-200">
